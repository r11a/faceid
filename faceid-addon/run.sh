...
faceid:
  ...
  known_evidence_max: $(cfg '.known_evidence_max // 300')
  unknown_evidence_max: $(cfg '.unknown_evidence_max // 300')
  ...
  recognition_session_seconds: $(cfg '.recognition_session_seconds // 300')
